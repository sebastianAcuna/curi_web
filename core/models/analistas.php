<?php
    ...
    class Analistas{
        ...
        private $user, $rut, $nombre, $email, $password, $apellido_p, $apellido_m, $telefono, $pais, $region, $comuna, $direccion, $provincia;
        ...
        public function traerDatos(){
            try{
                ...
                $sql = "SELECT U.id_usuario, U.user, U.rut, CONCAT(U.nombre,' ',U.apellido_p,' ',U.apellido_m) AS nombre, U.email FROM usuarios U INNER JOIN usuario_tipo_usuario UTU ON UTU.id_usuario = U.id_usuario $filtro $orden LIMIT $this->desde,10";
        ...
        public function traerInfo(){
            try{
                ...
                $conexion = new Conectar();
                $sql = "SELECT U.email, U.user, U.rut, U.nombre, U.apellido_p, U.apellido_m, U.telefono, U.id_pais, U.id_region, U.id_comuna, U.direccion, U.id_provincia FROM usuarios U INNER JOIN usuario_tipo_usuario UTU ON UTU.id_usuario = U.id_usuario WHERE U.id_usuario = ?";
                $conexion = $conexion->conexion();
                $consulta = $conexion->prepare($sql);
            ...
            try{
                ...
                if($consulta->rowCount() == 0 ){
                    ...
                    if($consulta->rowCount() > 0 && ($consulta->rowCount() == $consulta1->rowCount())){
                        ...
                        $sql = "INSERT INTO usuario_tipo_usuario (id_usuario, id_tu) VALUES (?, '4')";
                        $consulta = $conexion->prepare($sql);
                ...
                echo "[CREAR ANALISTA] -> ha ocurrido un error ".$e->getMessage();
        ...
        public function editarAnalista(){
            try{
                ...
                echo "[EDITAR ANALISTA] -> ha ocurrido un error ".$e->getMessage();
        ...
        public function traerComunas(){
            try{
                ...
                $conexion = new Conectar();
                $sql = "SELECT C.id_comuna, C.nombre FROM comuna C  WHERE C.id_provincia = ?";
                $conexion = $conexion->conexion();
                $consulta = $conexion->prepare($sql);
